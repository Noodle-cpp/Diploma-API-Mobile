...
{
    public interface IPetitionAttributeValue
    {
        AttributeViewModel CreateAttribute(PetitionAttributeItem attribute,
                                           AttributeViewModel createAttributeVM);
    }

    public class PetitionAttributeValue : IPetitionAttributeValue
    {
        #region Petition
        ...
        /// <returns></returns>
        public AttributeViewModel CreateAttribute(PetitionAttributeItem attribute,
                                                 AttributeViewModel createAttributeVM)
        {
